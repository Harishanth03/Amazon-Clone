    ...
    cartSummaryHTML += `
        <div class="cart-item-container js-cart-item-container-${matchingProduct.id}">
            <div class="delivery-date">
              Delivery date: Wednesday, June 21
            </div>
            ...
            <div class="cart-item-details-grid">
              ...
              <div class="delivery-options">
                ...
                ${deliveryOptionHTML(matchingProduct.id)}
              </div>
            </div>
          </div>
    `;
...
function deliveryOptionHTML(matchingProduct)
{
  ...
  deliveryOptions.forEach((deliveryOption) => {
    ...
    const priceString = deliveryOption.priceCents === 0 ? 'Free Options' : `$${formatCurrency(deliveryOption.priceCents / 100)}`;
